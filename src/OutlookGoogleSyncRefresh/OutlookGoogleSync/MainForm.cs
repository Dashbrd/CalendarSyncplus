...
namespace OutlookGoogleSync
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            cbHiddenMode.Checked = Settings.Instance.HiddenMode;
            ...
            // Hidden Mode
            if (cbHiddenMode.Checked && (Control.ModifierKeys & Keys.Shift) == 0)
            {
                this.ShowInTaskbar = false;
                Opacity = 0;
            }
        ...
        void SyncNow_Click(object sender, EventArgs e)
        {
            ...
            if(System.Net.NetworkInformation.NetworkInterface.GetIsNetworkAvailable() == true)
            {
                ...
                if (success == false)
                {
                    logboxout("Impossible to synchronize after 3 tries!");
                    logboxout(exception.ToString());
                }
            }
            else
            {
                LogBox.Clear();
                logboxout("No network available !");
            }
        ...
        private void cbHiddenMode_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Instance.HiddenMode = cbHiddenMode.Checked;
        }
