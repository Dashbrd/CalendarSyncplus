...
{
    /// <summary>
    ///     <see cref="HtmlSchema" /> class maintains <see langword="static" />
    ///     information about HTML structure can be used by <see cref="HtmlParser" />
    ...
    internal class HtmlSchema
    {
        ...
        /// <summary>
        ///     <see langword="static" /> constructor, initializes the ArrayLists
        ///     that hold the elements in various sub-components of the schema e.g
        ///     _htmlEmptyElements, etc.
        /// </summary>
        static HtmlSchema()
        {
        ...
        ///     <paramref name="xmlElementName" /> corresponds to empty element
        /// </summary>
        ...
        /// <summary>
        ///     returns <see langword="true" /> if <paramref name="xmlElementName" />
        ///     represents a block formattinng element. It used in an algorithm of
        ///     transferring inline elements over block elements in
        ///     <see cref="HtmlParser" />
        /// </summary>
        ...
        ///     <paramref name="xmlElementName" /> represents an inline formatting
        ///     element
        /// </summary>
        /// <param name="xmlElementName"></param>
        /// <returns>
        ...
        /// <summary>
        ///     It is a list of known html elements which we want to allow to
        ///     produce bt HTML parser, but don'tt want to act as inline, block or
        ///     no-scope. Presence in this list will allow to open elements during
        ///     html parsing, and adding the to a tree produced by html parser.
        /// </summary>
        ...
        /// <summary>
        ///     returns <see langword="true" /> when
        ///     <paramref name="xmlElementName" /> closes when the outer element
        ///     closes this is <see langword="true" /> of elements with optional
        ///     start tags
        /// </summary>
        /// <param name="xmlElementName">
        ///     string representing name to test
        ...
        /// <summary>
        ///     returns <see langword="true" /> if the current element closes when
        ///     the new element, whose name has just been read, starts
        /// </summary>
        ...
        /// <summary>
        ///     returns <see langword="true" /> if the string passed as argument is
        ///     an Html entity name
        /// </summary>
        ...
        /// <summary>
        ///     returns the character represented by the entity name string which is
        ///     passed as an argument, if the string is an entity name as specified
        ///     in _htmlCharacterEntities, returns the character value of 0
        ///     otherwise
        /// </summary>
        /// <param name="entityName">
        ...
        /// <summary>
        ///     initializes <see cref="_htmlEmptyElements" /> with empty elements in
        ///     HTML 4 spec at http://www.w3.org/TR/REC-html40/index/elements.html
        /// </summary>
        ...
        /// <summary>
        ///     initializes <see cref="_htmlElementsClosingOnParentElementEnd" />
        ///     with the list of HTML 4 elements for which closing tags are optional
        ///     we assume that for any element for which closing tags are optional,
        ///     the element closes when it's outer element (in which it is nested)
        ///     does
        /// </summary>
        ...
        /// <summary>
        ///     initializes <see cref="_htmlCharacterEntities" /> hashtable with the
        ///     character corresponding to entity names
        /// </summary>
